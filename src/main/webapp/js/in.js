...
~function() {
	...
	In.add('bootstrapjs3', {
		...
		type : 'js',
		rely : [ 'jquery', 'twitter-bootstrap-hover-dropdown' ]
	});

	In.add(
					'twitter-bootstrap-hover-dropdown',
					{
						path : '/js/bootstrap.3.0.3/js/twitter-bootstrap-hover-dropdown.min.js',
						type : 'js'
					});
	In.add('latest', {
		path : '/js/jquery-latest.js',
		type : 'js',
		rely : [ 'jquery' ]
	});
	In.add('tablesorter', {
	...
	In.add('supplier_search', {
		path : '/js/qegoo.supplier_search.js',
		type : 'js',
		rely : [ 'jquery' ]
	});
	
	In.add('task_table_search', {
		path : '/js/qegoo.task_table_search.js',
		type : 'js',
		rely : [ 'jquery' ]
	});
	...
	In.add('validatorZhCn',{
		path:'/js/bootstrapValidator/js/language/zh_CN.js',
		type:'js',
		rely:['validator' ]
	})
	In.add('validator',{
		path:'/js/bootstrapValidator/js/bootstrapValidator.min.js',
		type:'js',
		rely:['bootstrapjs3','jquery']
	})
	
	In.add('validatorcss',{
		path:'/js/bootstrapValidator/css/bootstrapValidator.min.css',
		type:'js',
		rely:['bootstrapcss3']
	})
	
	
	// js:jquery-highlighter:20.1.1
